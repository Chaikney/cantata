Cantata - Historical README 
===========================

This is the previous front page README of Cantata by Craig Drummond, kept here for reference only. It should not be relied on. The original code repo can be found at https://github.com/CDrummond/cantata

**WARNING** Everything below this is the previous README and may be outdated
